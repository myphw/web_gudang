...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <?= form_error('form/sj_item_checkout_rossi', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
            ...
            <!-- Buttons -->
                ...
                <a href="<?= base_url('warehouse/export_sj_checkout_rossi_pdf/' . $sp['id_spk'] . '/' . $sj['id_sj']); ?>" class="badge badge-danger mb-3" target="_blank">PDF</a>
                ...
                <tbody>
                    ...
                    <?php if ($po['id_sj'] == $current_sj['id_sj']): ?>
                        <tr>
                            ...
                            <?php endforeach; ?>
                            <td>
                                <a href="<?= base_url('warehouse/delete_sj_checkout_rossi/'.$po['id_bsj']. '/' . $po['id_bsj']) ?>" class="badge badge-danger">Delete</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                <?php endforeach; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newSjItemModalLabel">Add New Item ROSSI To Check OUT</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('warehouse/sj_item_checkout_rossi/'.$sp['id_spk'] . '/' . $sp['id_sj']);?>" method="post">
...
<div class="modal fade" id="newKeteranganModal" tabindex="-1" aria-labelledby="newKeteranganModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('warehouse/update_checkout_keterangan_rossi/' . $sp['id_spk'] . '/' . $sp['id_sj']); ?>" method="post">
                <div class="modal-header">
