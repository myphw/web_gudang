...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?= form_error('form/sj_item_blackstone', '<div class="alert alert-danger" role="alert">', '
                </div>'); ?>
            ...
            <?php endforeach; ?>
            <?php foreach ($insj as $sj): $sj = $insj[0]; ?>
                <div class="box-body">
                    <div class="form-group" style="display:inline-block;">
                        <input type="hidden" name="id_spk" value="<?= $sj['id_spk'] ?>">
                        <label for="no_do" style="width:87%;margin-left: 0px;">NO. DO</label>
                        <input type="text" name="no_do" style="width: 90%;margin-right: 0px;margin-left: px;" class="form-control" id="no_do" value="<?= $sj['no_do'] ?>" readonly placeholder="No DO">
                    </div>
                    <div class="form-group" style="display:inline-block;">
                    ...
                    <div class="form-group" style="display:inline-block;">
                        <label for="supplier_name" style="width:87%;margin-left: 0px;">Supplier Name</label>
                        <input type="text" name="supplier_name" style="width: 90%;margin-right: 0px;margin-left: px;" class="form-control" id="supplier_name" value="<?= $sj['supplier_name'] ?>" readonly placeholder="Supplier Name">
                    </div>
                    <div class="form-group" style="display:inline-block;">
                        <label for="no_plat" style="width:87%;margin-left: 0px;">NO Plat</label>
                        <input type="text" name="no_plat" style="width: 90%;margin-right: 0px;margin-left: px;" class="form-control" id="no_plat" value="<?= $sj['no_plat'] ?>" readonly placeholder="No Plat">
                    </div>
                    <div class="form-group" style="display:inline-block;">
                        <label for="tgl_checkin" style="width:87%;margin-left: 0px;">Tanggal Checkin</label>
                        <input type="date" name="tgl_checkin" style="width: 90%;margin-right: 0px;margin-left: px;" class="form-control" id="tgl_checkin" value="<?= $sj['tgl_checkin'] ?>" readonly placeholder="">
                    </div>
                </div>
            ...
            <a href="<?= base_url('warehouse/export_sj_blackstone/' . $sp['id_spk'] . '/' . $sj['id_sj']); ?>" class="badge badge-danger mb-3" target="_blank">PDF</a>
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th scope="col-lg-2">#</th>
                        <th scope="col-lg-4">Item name</th>
                    ...
                    <?php foreach ($spkitem as $po) : ?>
                        <?php if ($po['id_sj'] == $current_sj['id_sj']): ?>
                            <tr>
                                ...
                                <?php endfor; ?>
                                <!-- <td>
                            <a href="<?= base_url('warehouse/delete_sj_blackstone/' . $po['id_bsj'] . '/' . $sj['id_sj']) ?>" name="btn-delete" class="badge badge-danger">delete</a>
    ...
    <div class="modal fade" id="newSjItemModal" tabindex="-1" aria-labelledby="newSjItemModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('warehouse/sj_item_blackstone/' . $sp['id_spk'] . '/' . $sp['id_sj']); ?>" method="post">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="no_do" value="<?= $sp['no_do']; ?>">
                        <input type="hidden" name="no_sj" value="<?= $sp['no_sj']; ?>">
                        <input type="hidden" name="supplier_name" value="<?= $sp['supplier_name']; ?>">
                        <input type="hidden" name="no_plat" value="<?= $sp['no_plat']; ?>">
                        <input type="hidden" name="tgl_checkin" value="<?= $sp['tgl_checkin']; ?>">
...
<?php if (!empty($insj)) : $sp = $insj[0]; ?>
    <div class="modal fade" id="newKeteranganModal" tabindex="-1" aria-labelledby="newKeteranganModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= base_url('warehouse/update_keterangan_blackstone/' . $sp['id_spk'] . '/' . $sp['id_sj']); ?>" method="post">
                    <div class="modal-header">
