...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <?= form_error('form/sj_item_ariat', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
            ...
            <a href="<?= base_url('warehouse/export_sj_ariat/' . $sp['id_spk'] . '/' . $sj['id_sj']) ?>" class="badge badge-danger mb-3" target="_blank">PDF</a>
                    ...
                    <?php foreach ($spkitem as $po): ?>
                        <?php if ($po['id_sj'] == $current_sj['id_sj']): ?>
                            <tr>
                                ...
                                <?php endforeach; ?>
                                <!-- <td>
                            <a href="<?= base_url('warehouse/delete_sj_ariat/' . $po['id_bsj']) ?>" class="badge badge-danger">Delete</a>
                        </td> -->
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
...
<?php if (!empty($insj)) : $sp = $insj[0]; ?>
    <div class="modal fade" id="newKeteranganModal" tabindex="-1" aria-labelledby="newKeteranganModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= base_url('warehouse/update_keterangan_ariat/' . $sp['id_spk'] . '/' . $sp['id_sj']); ?>" method="post">
                    <div class="modal-header">
