            ...
            <?= form_error('form','<div class="alert alert-danger" role="alert">', '
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $co['brand_name']?></td>
                        <td><?= $co['tgl_checkin']?></td>
                        <td><?= $co['supplier_name']?></td>
                        <td><?= $co['no_plat']?></td>
                        <td><?= $co['created_at']?></td>
                        <td>
                            
                            <a href="<?= base_url('warehouse/sj_detail_item/' . $co['id_spk'] . '/' . $co['id_sj']) ?>" class="badge badge-success" >Detail</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
