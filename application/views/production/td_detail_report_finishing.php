...
$sizesRossi = ['3', '3t', '4', '4t', '5', '5t', '6', '6t', '7', '7t', '8', '8t', '9', '9t', '10', '10t', '11', '11t', '12','12t', '13','13t', '14', '15'];
?>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php $sp = $spk; ?>
                ...
                <a href="<?= base_url('production/export_finishing_pdf/' . $sp['id_spk']) ?>" class="btn btn-danger mb-3" target="_blank">Export PDF</a>
