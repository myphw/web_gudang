    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?= form_error('production/progress_report','<div class="alert alert-danger" role="alert">', '
                </div>'); ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $po['total_qty'];?></td>
                        <td>
                            <a type="button" class="badge badge-success"  href="<?=base_url('production/pr_detail_item/'.$po['id_spk'])?>" name="btn_add" style="margin:auto;">Detail View</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
