...
<div class="container-fluid">
    ...
    <?= form_error('form/view_report_blackstone', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
    <?= $this->session->flashdata('message'); ?>
                ...
                <a href="<?= base_url('executive/export_blackstone_pdf/' . $spk[0]['id_spk']) ?>" class="badge badge-danger mb-3" target="_blank">PDF</a>
